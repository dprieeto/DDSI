...
public class Monitor implements Serializable {
    ...
    private Set<Actividad> actividadResponsable;

    public Monitor() {
        this.actividadResponsable = new HashSet<Actividad>();
    }
    ...
    @XmlTransient
    public Set<Actividad> getActividadResponsable() {
        return actividadResponsable;
    }

    public void setActividadResponsable(Set<Actividad> actividadSet) {
        this.actividadResponsable = actividadSet;
    }
